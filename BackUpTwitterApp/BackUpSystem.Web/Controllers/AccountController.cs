...
namespace BackUpSystem.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var result = await this.userService.GetAllFavoriteUsers("5555");
            ...
            this.twitterAccountService.DeleteTwitterAccountFromUser("5555", "822215679726100480");
            var result2 = await this.userService.GetAllFavoriteUsers("5555");
